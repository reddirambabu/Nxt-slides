...
class NxtSlides extends Component {
  state = {
    ...
    activeHeadingValue: initialSlidesList[0].heading,
    activeDescriptionValue: initialSlidesList[0].description,
  }
      ...
      <ol className="slides-list-container">
        {slidesList.map(eachSlide => {
          ...
          const activeSlideClassName =
            activeSlideId === eachSlide.id ? 'active-slide' : ''
          ...
          const onClickChangeActiveTabFromSlidesBar = () => {
            this.setState({
              ...
              activeHeadingInput: false,
              activeDescriptionInput: false,
              activeHeadingValue: eachSlide.heading,
              activeDescriptionValue: eachSlide.description,
            })
          }
  ...
  onBlurChangeDescriptionElement = () => {
    const {activeHeadingValue, activeDescriptionValue} = this.state
